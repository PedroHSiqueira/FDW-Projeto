...
export default function Navbar() {
  ...
  return (
    <View style={tw`flex-row p-4 shadow-lg bg-white justify-between items-center`}>
      ...
      <Link
        className="px-2 py-1 ml-2 rounded-full border-[2px] border-[#101829]"
        href={"/"}
      >
      ...
      <Link href="/login/page" asChild>
        <Text style={tw`bg-white px-2 ml-2 py-1 font-bold rounded-full border-[2px] border-[#101829] text-xs`}>
        Entrar Agora
        </Text>
      </Link>
      </View>
